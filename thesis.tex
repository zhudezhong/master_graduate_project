...
% 消除 xeCJK 对 \ttfamily/\sffamily 的警告：指定 CJK 等宽与无衬线字体（macOS 若报错可改为 Kaiti SC / Heiti SC）
...
% 章标题：章号单独一行居中，标题在第二行居中（过长时多行均居中）
...
\input{data/chap01}
\input{data/chap02}
\input{data/chap03_scph}
\input{data/chap04_mih}
\input{data/chap05_app_system}
\input{data/chap06_conclusion}
% 参考文献
\clearpage
